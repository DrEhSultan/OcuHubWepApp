                ...
                <div className="overflow-x-auto scrollbar-hide px-4 sm:px-6 lg:px-8">
                  <div className="flex gap-4 sm:gap-6 pb-4">
                    {[
                      ...
                      { src: '/screenshots/Kids Vision Chart.png', title: 'Vision Tests', gradient: 'from-purple-500 to-pink-500' },
                      { src: '/screenshots/LASIK Ectasia.png', title: 'Clinical Tools', gradient: 'from-green-500 to-emerald-500' },
                      { src: '/screenshots/Retinoscopy.png', title: 'Diagnostics', gradient: 'from-orange-500 to-red-500' },
                      { src: '/screenshots/E Chart.png', title: 'E-Chart', gradient: 'from-teal-500 to-blue-500' },
                      { src: '/screenshots/Kids Fixation.png', title: 'Pediatric', gradient: 'from-pink-500 to-rose-500' },
