...
-- =====================================================
-- CREDITS/ACKNOWLEDGMENTS TABLES
-- =====================================================
...
CREATE POLICY "credit_asset_types_service_all" ON public.credit_asset_types FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "credit_sites_service_all" ON public.credit_sites FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "credit_links_service_all" ON public.credit_links FOR ALL USING (auth.role() = 'service_role');
...
-- Credits Triggers
CREATE TRIGGER trigger_credit_asset_types_updated_at BEFORE UPDATE ON public.credit_asset_types FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER trigger_credit_sites_updated_at BEFORE UPDATE ON public.credit_sites FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER trigger_credit_links_updated_at BEFORE UPDATE ON public.credit_links FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
