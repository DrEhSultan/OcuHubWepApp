  ...
  return (
    <div className="space-y-3">
      ...
      {sortedTools.map((tool) => {
        const mergedEvents = mergeEvents(tool.events);
                        ...
                        <tr key={event.id} className="border-b border-white/5 hover:bg-white/5">
                          ...
                          <td className="px-3 py-2">
                            <span className={`px-2 py-0.5 rounded text-xs ${
                              event.eventType === 'session' ? 'bg-indigo-500/20 text-indigo-300' :
                              ...
                              {event.eventType === 'session' ? 'open → close' : event.eventType}
                            </span>
                          </td>
